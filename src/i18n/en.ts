...
export const en = {
  ...
  aiMascot: {
    ...
    hideLabel: "Hide assistant for 48 hours",
    restoreLabel: "Show assistant",
    chatTitle: "AI Kacper",
    chatSubtitle: "Portfolio, code and quick actions",
    personaLabel: "human-ish portfolio copilot",
    greeting: "Need a quick B-CRM summary, a project shortcut, or code help?",
    initialMessage:
      "Hey, I am the little portfolio sidekick. I can explain projects, open sections, book a call, or look at a small code problem. No secrets or API keys, deal?",
    placeholder: "Write a question...",
    placeholderVoice: "Write or say something...",
    inputLabel: "Message for the AI assistant",
    sendLabel: "Send message",
    micLabel: "Start voice input",
    stopMicLabel: "Stop voice input",
    voiceCallLabel: "Call",
    endCallLabel: "End",
    muteLabel: "Mute voice",
    unmuteLabel: "Unmute voice",
    voiceIdleLabel: "Text chat ready",
    voiceReadyLabel: "Voice mode ready",
    voiceListeningLabel: "Listening on the mic",
    voiceThinkingLabel: "Thinking through it",
    voiceSpeakingLabel: "Speaking back",
    voiceMutedLabel: "Voice muted, still listening",
    voiceUnavailableLabel: "Voice unavailable",
    voiceCallIntro:
      "Voice mode is on. Talk to me like a quick phone call: ask about projects, code, contact, or where to go next on the page.",
    listeningLabel: "Listening...",
    thinkingLabel: "Thinking...",
    voiceHint: "Use the mic to talk. I can read the answer back.",
    voiceCallHint: "Voice call mode is on. I listen, answer, then reopen the mic.",
    voiceUnsupported: "Voice input is not supported in this browser.",
    voicePermissionError: "I could not access the microphone. You can still write normally.",
    errorMessage: "The assistant is not available right now. Try again later.",
    quickActions: {
    ...
    booking: {
      loadingDays: "Checking available days...",
      loadingSlots: "Checking free times...",
      chooseDay: "Choose a day",
      unavailable: "Booking is temporarily unavailable here. You can still use the contact section.",
      name: "Your name",
      email: "Email",
      topic: "Short topic",
      submit: "Book this time",
      success: "Done. The meeting is booked and confirmation should arrive by email.",
      error: "I could not book this time. Try another slot or use direct contact.",
    },
  },
  projects: {
    title: "Projects",
