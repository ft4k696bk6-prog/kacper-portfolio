...
export const en = {
  ...
  aiConsultant: {
    ...
    title: "Ask about the projects, stack or a code problem.",
    description:
      "A small NVIDIA-powered assistant can summarize the portfolio, compare projects, suggest what to review first and help you reason through frontend code. It behaves, mostly.",
    badges: ["Portfolio context", "Code help", "NVIDIA NIM"],
    panelTitle: "Portfolio sidekick",
    panelSubtitle: "Project evidence, code hints and short answers without opening another tab.",
    statusLabel: "online",
    initialMessage:
      "Hey, I am the portfolio sidekick. Ask about B-CRM, the tech stack, case studies, or drop a small code issue and I will try to help. Please do not paste secrets, API keys or private data.",
    prompts: [
      "Why is B-CRM the strongest project?",
      "I have a React/Next bug. How should I debug it?",
      "Can you review a small TypeScript snippet?",
      "What should a technical recruiter review first?",
    ],
    inputLabel: "Question for the AI consultant",
    placeholder: "Ask about B-CRM, stack, case studies, or paste a small code snippet...",
    sendLabel: "Ask",
    loadingLabel: "Thinking... suspiciously hard.",
    codeHelpLabel: "Got a code problem? Drop a small snippet, maybe I can help.",
    enterHint: "Enter sends, Shift+Enter adds a line.",
    safetyNote: "Tiny rule: no API keys, passwords, tokens or private customer data in chat.",
