export const en = {
  ...
  about: {
    ...
    workflowNote:
      "B-CRM shows a complete flow: auth, roles, data, statuses, forms and deployment.",
  ...
  contact: {
    ...
    booking: {
      ...
      configErrorLabel: "Online booking is temporarily unavailable. The contact form still works.",
      blockedWeekendLabel: "Weekends are unavailable",
      blockedMondayLabel: "Mondays are unavailable",
      blockedVacationLabel: "Blocked during travel",
    },
