...
export const pl: Translations = {
  ...
  aiMascot: {
    ...
    hideLabel: "Schowaj asystenta na 48 godzin",
    restoreLabel: "Pokaż asystenta",
    chatTitle: "AI Kacper",
    chatSubtitle: "Portfolio, kod i szybkie akcje",
    personaLabel: "ludzki copilot portfolio",
    greeting: "Streścić B-CRM, pokazać projekt albo pomóc z kodem?",
    initialMessage:
      "Hej, jestem małym sidekickiem portfolio. Mogę wyjaśnić projekty, otworzyć sekcje, umówić rozmowę albo zerknąć na mały problem z kodem. Bez sekretów i kluczy API, umowa?",
    placeholder: "Napisz pytanie...",
    placeholderVoice: "Napisz albo powiedz...",
    inputLabel: "Wiadomość do asystenta AI",
    sendLabel: "Wyślij wiadomość",
    micLabel: "Włącz mikrofon",
    stopMicLabel: "Zatrzymaj mikrofon",
    voiceCallLabel: "Dzwoń",
    endCallLabel: "Koniec",
    muteLabel: "Wycisz głos",
    unmuteLabel: "Włącz głos",
    voiceIdleLabel: "Czat tekstowy gotowy",
    voiceReadyLabel: "Tryb rozmowy gotowy",
    voiceListeningLabel: "Słucham przez mikrofon",
    voiceThinkingLabel: "Myślę nad tym",
    voiceSpeakingLabel: "Odpowiadam głosem",
    voiceMutedLabel: "Głos wyciszony, nadal słucham",
    voiceUnavailableLabel: "Głos niedostępny",
    voiceCallIntro:
      "Tryb rozmowy jest włączony. Mów do mnie jak przez krótki telefon: projekty, kod, kontakt albo gdzie kliknąć dalej.",
    listeningLabel: "Słucham...",
    thinkingLabel: "Myślę...",
    voiceHint: "Możesz mówić do mikrofonu. Odpowiedź mogę odczytać głosem.",
    voiceCallHint: "Tryb rozmowy jest włączony. Słucham, odpowiadam i znów otwieram mikrofon.",
    voiceUnsupported: "Ta przeglądarka nie wspiera wejścia głosowego.",
    voicePermissionError: "Nie udało się uzyskać dostępu do mikrofonu. Nadal możesz pisać normalnie.",
    errorMessage: "Asystent jest teraz niedostępny. Spróbuj ponownie później.",
    quickActions: {
    ...
    booking: {
      loadingDays: "Sprawdzam dostępne dni...",
      loadingSlots: "Sprawdzam wolne godziny...",
      chooseDay: "Wybierz dzień",
      unavailable: "Rezerwacja jest chwilowo niedostępna tutaj. Nadal możesz użyć sekcji kontaktu.",
      name: "Imię i nazwisko",
      email: "Email",
      topic: "Krótki temat",
      submit: "Zarezerwuj termin",
      success: "Gotowe. Spotkanie jest zarezerwowane, a potwierdzenie powinno przyjść na email.",
      error: "Nie udało się zarezerwować tego terminu. Wybierz inny slot albo użyj kontaktu.",
    },
  },
  projects: {
    title: "Projekty",
