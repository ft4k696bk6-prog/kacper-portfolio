...
export const pl: Translations = {
  ...
  aiConsultant: {
    ...
    title: "Zapytaj o projekty, stack albo problem z kodem.",
    description:
      "Mały asystent oparty o NVIDIA może podsumować portfolio, porównać projekty, podpowiedzieć co sprawdzić jako pierwsze i pomóc przejść przez problem frontendowy. Zachowuje się, przeważnie.",
    badges: ["Kontekst portfolio", "Pomoc z kodem", "NVIDIA NIM"],
    panelTitle: "Sidekick portfolio",
    panelSubtitle: "Dowody projektowe, wskazówki do kodu i krótkie odpowiedzi bez otwierania nowej karty.",
    statusLabel: "online",
    initialMessage:
      "Hej, jestem sidekickiem tego portfolio. Zapytaj o B-CRM, stack, case studies albo podrzuć mały problem z kodem, może pomogę. Tylko bez sekretów, kluczy API i prywatnych danych.",
    prompts: [
      "Dlaczego B-CRM jest najmocniejszym projektem?",
      "Mam błąd w React/Next. Jak go debugować?",
      "Możesz zerknąć na mały snippet TypeScript?",
      "Co osoba techniczna powinna sprawdzić jako pierwsze?",
    ],
    inputLabel: "Pytanie do konsultanta AI",
    placeholder: "Zapytaj o B-CRM, stack, case studies albo wklej mały fragment kodu...",
    sendLabel: "Zapytaj",
    loadingLabel: "Myślę... aż mi styki świecą.",
    codeHelpLabel: "Masz problem z kodem? Wrzuć mały fragment, może pomogę.",
    enterHint: "Enter wysyła, Shift+Enter dodaje linię.",
    safetyNote: "Mała zasada: nie wklejaj kluczy API, haseł, tokenów ani prywatnych danych.",
