...
export const pl: Translations = {
  ...
  about: {
    ...
    workflowTitle: "Web app workflow",
    workflowItems: ["Lead", "Status", "Role", "Dashboard"],
    workflowNote:
      "B-CRM pokazuje kompletny przepływ: auth, role, dane, statusy, formularze i deploy.",
  ...
  contact: {
    ...
    booking: {
      ...
      configErrorLabel: "Terminy online są chwilowo niedostępne. Formularz kontaktowy działa normalnie.",
      blockedWeekendLabel: "Weekend jest niedostępny",
      blockedMondayLabel: "Poniedziałek jest niedostępny",
      blockedVacationLabel: "Termin zablokowany na czas wyjazdu",
    },
